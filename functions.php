...
function pgRegisterBlock()
{
    ...
    register_block_type(
        'pgb/basic-block', // Nombre del bloque
        array(
			'editor_script' => 'pgb-js', // Handler del Script que registramos arriba
...
============================= */
add_action('acf/init', 'acfRegisterBlocks'); // hook creado por el plugin
...
function acfRegisterBlocks() {
	acf_register_block(
		array(
			...
			'category' => 'layout', //categorias de Guttenberg
			'icon' => 'smiley',
			'mode' => 'edit' // OJO esto no esta para bloques nativos
		)
	);
}
