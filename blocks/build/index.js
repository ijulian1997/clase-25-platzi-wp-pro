...
/* harmony import */ var _wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_4__);
 ...
 // Mejorar experiencia con SSR


Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])('pgb/basic-block', // as registered ad functions.php
{
  title: 'Basic Block',
  ...
  edit: function edit(props) {
    ...
    var content = props.attributes.content,
        ...
        isSelected = props.isSelected; // Función para guardar el atributo content

    var handlerOnChangeInput = function handlerOnChangeInput(newContent) {
      setAttributes({
        content: newContent
      }); // cada vez que cambie el valor del input, lo veamos reflejado en los atributos
    ...
    }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelBody"] // Segundo panel en el sidebar
    , {
    ...
    })))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_4___default.a // renderizado del bloque dinamico
    , {
